...
namespace SmartRdo.Data.Migrations
{
    ...
    [Migration("20200714234803_Ajusta-atividade")]
    partial class Ajustaatividade
    {
            ...
            modelBuilder.Entity("SmartRdo.Business.Models.Cliente", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a0195f94-2d22-4161-bef5-366b907afb64"),
                            Nome = "Cliente A"
                        },
                        new
                        {
                            Id = new Guid("a6d1af9d-8c1b-4973-bdf2-668dac3f5a6d"),
                            Nome = "Cliente B"
                        });
                });
