...
function obterInputChecklist(index) {
...
function obterBotaoRemoverItem(index) {
...
function removeRow(id) {
    ...
    document.querySelectorAll('.item-checklist').forEach((item, index) => {
        item.name = "ItensChecklist[" + (index + 1) + "].Descricao";
    });
}
//# sourceMappingURL=ItensChecklist.js.map